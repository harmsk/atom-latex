...
class JobState {
  ...
  getShouldClean () {
    return this.parent.getShouldClean()
  }
...
export default class BuildState {
  constructor (filePath, jobNames = [null], shouldRebuild = false, shouldClean = false) {
    this.setFilePath(filePath)
    this.setJobNames(jobNames)
    this.setShouldRebuild(shouldRebuild)
    this.setShouldClean(shouldClean)
  ...
  setShouldClean (value) {
    this.shouldClean = toBoolean(value)
  }
